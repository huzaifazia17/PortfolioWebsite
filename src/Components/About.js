...
const About = () => {
    return (
        <div>
            <div className='title'> <span>-----</span>About Me<span>-----</span></div>
            <div className='about-section'>
                <div className='about__container animate__animated animate__fadeInLeftBig'>
                    <p>
                ...
                <div className='title'><span>-----</span>My Skills<span>-----</span></div>
                <div className='skills__container animate__animated animate__fadeInRightBig'>
                    <ul>
                        <li><div className='skill1'><img src={htmlimg} style={{ width: 70, height: 70 }} /></div>
                            <div className='skill1'> <p>HTML5</p></div></li>
                        <li><div className='skill2'><img src={javaimg} style={{ width: 70, height: 70 }} /></div>
                            <div className='skill2'><p>Java</p></div></li>
                        <li><div className='skill3'><img src={Angular} style={{ width: 70, height: 70 }} /></div>
                            <div className='skill3'><p>Angular</p></div></li>
                        <li><div className='skill4'><img src={ReactA} style={{ width: 70, height: 70 }} /></div>
                            <div className='skill4'><p>React</p></div></li>
                        <li><div className='skill5'><img src={Python} style={{ width: 70, height: 70 }} /></div>
                            <div className='skill5'><p>Python</p></div></li>
                    </ul>
                    <ul>
                        <li><div className='skill6'><img src={cssimg} style={{ width: 70, height: 70 }} /></div>
                            <div className='skill6'><p>CSS3</p></div></li>
                        <li><div className='skill7'><img src={sqlimg} style={{ width: 70, height: 70 }} /></div>
                            <div className='skill7'><p>MySQL</p></div></li>
                        <li><div className='skill8'><img src={jsimg} style={{ width: 70, height: 70 }} /></div>
                            <div className='skill8'><p>Javascript</p></div></li>
                        <li><div className='skill9'><img src={mongodb} style={{ width: 70, height: 70 }} /></div>
                            <div className='skill9'><p>Mongodb</p></div></li>
                        <li><div className='skill10'><img src={Express} style={{ width: 70, height: 70 }} /></div>
