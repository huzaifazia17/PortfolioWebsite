            ...
            <div className='Projects-container '>
                ...
                <a href="https://h2z2groceries.netlify.app/" target="_blank">
                    <div className='project1 ' data-aos="zoom-in" data-aos-duration="2000">
                        <div className='project-image'>
                            <img src={h2z2} alt="h2z2" style={{ width: 300, height: 200 }} />
                        </div>
                        <div className='project-info'>
                            <h1><FaGreaterThan /> Online Grocery Store</h1>
                            <h3><span>~</span>Led team of 4: Organized meetings, delegated tasks,<br></br> helped teammates debug, etc., leading to a final grade of 100% </h3>
                            ...
                            <h3><span><br></br><br></br>ReactJS Redux ExpressJS MySQL CSS React-Router Heroku</span></h3>
                        </div>
                ...
                <a href="https://huzaifazia17.github.io/DH8Transcriber/" target="_blank">
                    <div className='project2' data-aos="zoom-in" data-aos-duration="2000">
                        <div className='project-image'>
                            <img src={robo} alt="robo" style={{ width: 300, height: 200 }} />
                        </div>
                        <div className='project-info'>
                            ...
                            <h3><span><br></br><br></br>HTML CSS Javascript AssemblyAI-API </span></h3>
                        </div>
                ...
                <a href="https://github.com/huzaifazia17/ContentBasedImageRetrieval" target="_blank">
                    <div className='project3' data-aos="zoom-in" data-aos-duration="2000">
                        <div className='project-image'>
                            <img src={barcode} alt="barcode" style={{ width: 300, height: 200 }} />
                        </div>
                        <div className='project-info'>
                            <h1><FaGreaterThan /> Content Based Image Retrieval </h1>
                            <h3><span>~</span>Developed a Python program that converts a black<br></br> and white image into a barcode using angled projections.</h3>
                            <h3><span>~</span>The program can then search through a list of input Images<br></br> or barcodes to find the most similar ones with an accuracy of 80%. </h3>
